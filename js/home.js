    ...
    <div class="hero-slide">
      ...
      <div class="hero-content">
        ...
        <div class="hero-actions">
          <a class="read-btn" href="detail.html">&#9654; Read Now</a>
...
function renderTrendingByCategory(category){
  ...
  function renderRecommended(list){
    document.getElementById("recommended").innerHTML = list.map(item=>`
      <a class="reco-link" href="detail.html">
        <div class="reco-item">
          <img src="${item.image}" alt="${item.title}">
          <div class="reco-info">
...
const nowSpotlight = document.getElementById("wtNowSpotlight");
const mood = document.getElementById("wtMood");
const indicators = document.getElementById("wtIndicators");

const categoryMood = {
    Webtoon: "Cinematic fantasy",
    Novel: "Immersive mystery",
    Knowledge: "Focused learning",
    Comics: "Bold visual energy"
};
...
function updateContent() {
    ...
    nowSpotlight.textContent = current.name;
    mood.textContent = categoryMood[current.name] || "Featured stories";
}
